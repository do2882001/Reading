 ...
 * @author phong
 */
public class CheckInfoForm extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("VERIFICATION INFORMATION");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CheckInfoForm.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new CheckInfoForm().setVisible(true);
            }
        });
    }
